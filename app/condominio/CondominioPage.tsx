...
export default function CondominioPage({ eyebrow, title, accent, intro, details, highlight }: Props) {
  return <main className="inner-page">
    ...
    <section className="inner-hero"><img className="inner-hero-image" src="/guanabara-sunset.jpg" alt="Baía de Guanabara ao pôr do sol" /><div className="inner-hero-shade" /><div className="inner-hero-content"><p className="breadcrumb"><a href="/">Início</a><span>—</span>Condomínio</p><p className="eyebrow">{eyebrow}</p><h1>{title}<br /><em>{accent}</em></h1></div></section>
    ...
    <section className="inner-cta"><p className="section-label">ATENDIMENTO PERSONALIZADO</p><h2>{highlight}</h2><a className="button light" href="/#contato">Fale com a Chindler <span>→</span></a></section>
